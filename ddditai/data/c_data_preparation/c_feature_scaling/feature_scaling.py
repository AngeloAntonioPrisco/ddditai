...
if __name__ == "__main__":
    # This main can be used for manual feature scaling of a specific mlflow run that produced a csv
    ...
    feature_scaling_mlflow_run(args.run_id, args.artifact_path)
